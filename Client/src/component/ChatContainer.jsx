...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return selectedUser ? (
    // header section of chat container
    <div className='h-full flex flex-col overflow-scroll relative backdrop-blur-lg'>
      ...
      {/* chat section */}
      <div className='flex flex-col h-[83%] overflow-y-scroll p-3 pb-10]'>
